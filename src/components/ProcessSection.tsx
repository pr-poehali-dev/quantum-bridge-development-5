...
const steps = [
  ...
  {
    icon: PaletteIcon,
    title: "Сборка с помощью ИИ",
    description:
      "Создаём сайт, ускоряя рутину с помощью искусственного интеллекта. Стильный дизайн под ваш бренд, удобный для клиентов и технически безупречный — за считанные дни.",
    number: "02",
  },
  {
    icon: Rocket,
